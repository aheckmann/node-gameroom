...
var Gameroom = module.exports.Gameroom = function(app, options){
  console.log("new Gameroom")

  this.DURATION = app.set("game duration")
  assert.ok(this.DURATION)
  this.MAX_PLAYERS = app.set("game max players") || DEFAULT_MAX_PLAYERS
  this.MIN_PLAYERS = app.set("game min players") || DEFAULT_MIN_PLAYERS
  this.PREGAME_COUNTDOWN_DURATION = app.set("game countdown duration") || DEFAULT_COUNTDOWN_DURATION
